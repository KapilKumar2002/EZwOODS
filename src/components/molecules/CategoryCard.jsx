...
const CategoryCard = (props) => {
  ...
  return (
    <div className="font-headingFont md:w-72 w-40 lg:h-56 md:h-44 h-20 flex flex-col justify-center items-center bg-disabledColor rounded-xl shadow-sm hover:bg-primaryColor duration-500 p-1">
